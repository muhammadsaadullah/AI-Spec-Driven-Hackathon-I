...
Before diving into the course content, make sure to review the [Hardware Requirements](/docs/hardware-requirements) and complete the [Setup Guide](/docs/hardware-requirements/workstation-setup).

Ready to begin your journey into Physical AI? Start with the [first module on ROS 2 fundamentals](/docs/modules/ros2).