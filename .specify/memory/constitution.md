<!--
Sync Impact Report:
Version change: 2.0.0 (old) -> 2.0.0 (new)
Modified principles: All principles are newly defined or substantially updated from a generic template.
Added sections: All sections are newly defined based on the prompt.
Removed sections: None (template placeholders are replaced).
...
Physical AI integrates AI, physics, and robotics—errors propagate across domains and may lead to: Unstable simulations and control policies, incorrect robot behavior, invalid locomotion models, unsafe hardware interaction, simulation/real-world divergence, and broken perception pipelines. Accuracy directly affects both learning quality and real-robot safety. Accuracy is non-negotiable in an embodied intelligence textbook.
